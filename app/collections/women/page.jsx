    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="relative h-112.5 md:h-137.5 overflow-hidden">
        ...
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1483985988355-763728e1935b?w=1600&h=800&fit=crop"
        ...
        <div className="relative h-full max-w-7xl mx-auto px-6 flex flex-col justify-center">
          <div className="max-w-2xl">
            ...
            <p className="text-white/70 text-sm md:text-base mt-4 max-w-md leading-relaxed">
              Discover our premium collection of streetwear designed for the modern woman.
        ...
        <div>
          <div className="flex items-center justify-between mb-10">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tight text-black mt-2">
                Featured for <span className="bg-linear-to-r from-black to-gray-600 bg-clip-text text-transparent">Women</span>
              </h2>
            </div>
            <Link
              href="/shop"
        ...
        <div className="mt-20 bg-black rounded-3xl p-10 md:p-16 text-center relative overflow-hidden group">
          ...
          <div className="relative">
            ...
            <h3 className="text-3xl md:text-5xl font-black text-white uppercase tracking-tight">
              New Collection <span className="text-transparent bg-clip-text bg-linear-to-r from-pink-300 to-white">Drops</span>
            </h3>
