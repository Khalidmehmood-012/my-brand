    ...
    <div className="bg-white min-h-screen">
      <div className="max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="mt-4">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-12 h-12 rounded-xl bg-black text-white flex items-center justify-center hover:bg-gray-800 hover:scale-110 transition-all duration-300"
                >
          ...
          {/* Right — Contact Form (Improved Visibility) */}
          <div>
            {submitted ? (
              ...
              <div className="bg-white rounded-3xl p-6 md:p-8 border-2 border-black shadow-lg">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 text-sm text-black outline-none focus:border-black transition placeholder:text-gray-400 bg-gray-50 focus:bg-white"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full border-2 border-gray-200 rounded-xl px-4 py-3.5 text-sm text-black outline-none focus:border-black transition placeholder:text-gray-400 bg-gray-50 focus:bg-white resize-none"
                    />
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-black text-white py-4 rounded-xl font-bold text-sm uppercase tracking-widest hover:bg-gray-800 transition-all duration-300 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-2 mt-2"
                  >
