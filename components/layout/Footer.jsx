    ...
    <footer className="bg-black text-white mt-20">
      <div className="max-w-7xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex gap-3 mt-4">
            <a
              ...
              className="w-10 h-10 rounded-full bg-gray-800 hover:bg-white hover:text-black transition-all duration-300 flex items-center justify-center group"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-gray-400 group-hover:text-black transition-colors">
        ...
        <div>
          ...
          <ul className="flex flex-col gap-2">
            ...
            <li>
              <Link href="/return-exchange" className="text-gray-400 hover:text-white text-sm transition">
                Return & Exchange
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <div className="flex flex-col gap-2">
            <input
              ...
              className="bg-gray-800 text-white text-sm px-4 py-2.5 rounded-xl outline-none focus:ring-2 focus:ring-white placeholder:text-gray-500"
            />
            <button className="bg-white text-black text-sm font-bold py-2.5 rounded-xl hover:bg-gray-200 transition uppercase tracking-wider">
              Subscribe
            </button>
          </div>
        </div>
      ...
      <div className="border-t border-gray-800 py-4 text-center">
        <p className="text-gray-500 text-xs">
          © 2026 Komrez. All rights reserved. Made with in Pakistan
        </p>
      </div>
    </footer>
  )
